...
@interface FBYScanBankCard : FBYScanBankCardBase

@property (nonatomic, copy) void(^scanSuccess)(FBYBankCardModel * model);
@property (nonatomic, copy) void(^scanError)(NSError * error);
